#!/bin/bash
# FROM https://raw.githubusercontent.com/buildkite-plugins/docker-compose-buildkite-plugin/master/lib/shared.bash
...
function plugin_read_config() {
  local var="BUILDKITE_PLUGIN_EFS_CACHE_${1}"
  local default="${2:-}"
  echo "${!var:-$default}"
}
...
function plugin_read_list() {
  prefix_read_list "BUILDKITE_PLUGIN_EFS_CACHE_$1"
}
